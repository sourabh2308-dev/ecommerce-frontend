...
import { ArrowLeft, Star, PackageCheck, Truck, CheckCircle2, Clock, MapPin } from 'lucide-react'
    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="font-mono text-sm text-gray-400 mt-1">#{order.uuid}</p>
        </div>
              ...
              {order.items.map((item) => (
                <div key={item.productUuid} className="py-4 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-400 font-mono">#{item.productUuid.slice(0, 8)}</p>
